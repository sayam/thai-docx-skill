...
Tried on 18 September 2026 with the archive of version 0.1.1: the upload was accepted, a security scan
...
page also carries `thai-docx-0.2.1.intoto.jsonl`, download it beside the zip and check against it
...
| an exact version | `gh skill install … --pin v0.2.1` | — |
