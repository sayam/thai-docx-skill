...
ไม่มีตัวไหนผิด ถ้าอยากได้รุ่นที่โปรเจกต์นี้ทดสอบและเขียนบันทึกไว้ ให้เอาจาก release — ด้วย
`gh skill install` หรือดาวน์โหลด zip เอง ถ้าอยากได้สิ่งที่อยู่บน `main` วันนี้ก็เอาอันนั้น
แล้วคาดไว้ว่าหน้าอ้างอิงจะใหม่กว่า release ล่าสุด

การเขียน SKILL.md ใหม่คือเหตุผลที่ค่า checksum ของไฟล์ที่ติดตั้งแล้วจะไม่ตรงกับของเรา
