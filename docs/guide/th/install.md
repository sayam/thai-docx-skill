...
แถว **ลองแล้ว** บอกว่าผู้ดูแลสกิลได้ลองใช้ thai-docx ในแอปนั้นจริงหรือยัง แอปที่ยังไม่ได้ลอง
เขียนตามคู่มือของผู้ผลิต ที่อ่านเมื่อวันที่ 17 กันยายน 2569 ถ้าลองแล้วไม่ได้ ช่วย
...
|---|---|---|---|---|---|---|---|
| ลองแล้ว | ยัง | ลองแล้ว | ยัง | ยัง | ยัง | ยัง | ลองแล้ว |
...
ยังไม่ได้ลอง คู่มือของ Claude บอกว่าคำอธิบายสกิลยาวได้ไม่เกิน 200 ตัวอักษร รุ่น 0.1.0 ยาวเกิน รุ่นหลังจากนั้นไม่เกินแล้ว
ถ้าอัปโหลดไม่ผ่าน ช่วย [แจ้งที่หน้า Issues](https://github.com/sayam/thai-docx-skill/issues) พร้อมข้อความที่ขึ้น
...
ขั้นตอนละเอียดทีละขั้นอยู่ใน [PROMPT.th.md](https://github.com/sayam/thai-docx-skill/blob/main/PROMPT.th.md)
...
- **อัปเดต:** ลบโฟลเดอร์ `thai-docx` เก่าก่อน แล้วแตกไฟล์ zip ใหม่แบบเดิม
  ในแอป Claude หรือ ChatGPT ให้เปลี่ยนสกิลเป็น zip รุ่นใหม่
- **ดูว่าใช้รุ่นไหน:** ดูบรรทัด `version` ตอนต้นไฟล์ `thai-docx/SKILL.md`
- **ลบ:** ลบโฟลเดอร์ `thai-docx` หรือลบสกิลในแอป โปรไฟล์ยังอยู่ที่ `~/.thai-docx/profiles/`
  จนกว่าจะลบเอง
