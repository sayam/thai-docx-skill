...
จะได้ไฟล์ใหม่ ไฟล์เดิมไม่ถูกแตะ แก้ได้สองในเจ็ดข้อ (โหมดความเข้ากันได้ กับการปิดการตรวจคำสะกด)
ที่เหลือแจ้งไว้ใน `"remaining"` ส่วนเครื่องหมายที่ข้อความไทยต้องมียังซ่อมไม่ได้ในรุ่นนี้
ไฟล์ส่วนใหญ่จึงยังมีข้อผิดพลาดเหลืออยู่ และรายงานจะบอกว่าเหลือข้อไหน
ถ้ามีไฟล์ Markdown ต้นฉบับ การสร้างใหม่แก้ได้ครบกว่า
