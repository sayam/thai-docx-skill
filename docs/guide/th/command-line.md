...
| `--force-cs-whole-doc` | ใน Word ทุกข้อความใช้ฟอนต์เดียวกันทั้งเล่ม รวมทั้งภาษาอังกฤษและโค้ด (Google Docs ยังแสดงบล็อกโค้ดเป็นฟอนต์ความกว้างเท่ากัน) — สำหรับไฟล์ฉบับสุดท้ายที่จะอ่านอย่างเดียว Word จะขีดเส้นหยักใต้คำอังกฤษที่สะกดถูกบนหน้าจอ |
...
จะได้ไฟล์ใหม่ ไฟล์เดิมไม่ถูกแตะ (ถ้าไม่มีอะไรให้ซ่อม จะไม่เขียนไฟล์ใดเลย) ข้อที่แก้ให้คือ เครื่องหมายที่ทุกช่วงข้อความไทยต้องมี การปิดการตรวจคำสะกด
