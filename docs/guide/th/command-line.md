...
จะได้ไฟล์ใหม่ ไฟล์เดิมไม่ถูกแตะ แก้ได้สี่ในเจ็ดข้อ คือโหมดความเข้ากันได้ เครื่องหมายที่ทุกช่วงข้อความไทยต้องมี
การปิดการตรวจคำสะกด และคุณสมบัติคู่ของ complex script ส่วนคำที่ถูกแยกเป็นสองช่วง อักขระที่มองไม่เห็น
และลำดับคุณสมบัติที่ผิด จะแจ้งไว้ใน `"remaining"` แทน รายงานจะบอกด้วยว่าเขียนฟอนต์อะไรลงไป
ในที่ที่ไม่ได้ระบุไว้ ถ้าอยากเลือกเอง ใช้ `--font "Sarabun"`

ไฟล์ใหม่จะ**ใหญ่ขึ้น** เพราะส่วนที่เขียนใหม่เก็บแบบไม่บีบอัด เอกสารที่มีส่วน styles ใหญ่อาจโตขึ้นหลายเท่า
เปิดใน Word แล้วเซฟจะบีบกลับให้เอง ถ้ามีไฟล์ Markdown ต้นฉบับ การสร้างใหม่แก้ได้ครบกว่าและไฟล์เล็กกว่า
