...
| `--force-cs-whole-doc` | ทุกข้อความใช้ฟอนต์เดียวกันทั้งเล่ม รวมทั้งภาษาอังกฤษและโค้ด — สำหรับไฟล์ฉบับสุดท้ายที่จะอ่านอย่างเดียว Word จะขีดเส้นหยักใต้คำอังกฤษที่สะกดถูกบนหน้าจอ |
