...
> **Later (2026-09-24):** the WPS row did not reproduce on 2026-09-23, before or after ADR 0039; what changed is
...
--thai-digits --auto-numbering`, held as a golden. (**Later (2026-09-26):** it is built from every flag of
