...
| 6 ไม่มีสูตรเดียว | [0012](adr/0012-xml-checks-are-the-proxy-office-apps-the-oracle.md) · [0036](adr/0036-who-counts-is-one-switch.md) | บันทึกข้อจำกัดของรีลีสใน [`docs/evidence/`](evidence/) และ `references/numbering.md`, `references/chapters.md` กับคู่มือทั้งสองภาษา |
